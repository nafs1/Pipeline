...
pipeline_json = "./pipelinejson/Pipeline1.json"
...
pipeline_name = pipeline_data['pipelineName'] + now.strftime("%Y_%m_%d_%H_%M_%S")
...
for one_task in pipeline_tasks:
    ...
    if task_id == 1:
        print(task_input)
        shutil.copy("iris.csv",task_input)
